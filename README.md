...
Le site a été **généré à l’aide de Bolt.New** à partir d’un prompt spécifique, et conçu **en pur HTML/CSS**, sans JavaScript ni framework, afin de garantir :
